      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-8 text-center">
          <h2 className="mb-3 text-2xl font-semibold tracking-tight text-gray-900 sm:text-3xl">
            {t("commitment.title1")}{" "}
            <span className="text-green-600">{t("commitment.title2")}</span>
          </h2>
          <p className="mx-auto max-w-2xl text-xm text-gray-600">{t("commitment.desc")}</p>
        </div>
              ...
              >
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <h3
                      className={`text-xs sm:text-sm lg:text-[15px] font-extrabold uppercase tracking-tight lg:tracking-wide transition-colors ${
                  ...
                  <div className="relative w-6 h-6 flex-shrink-0">
                    <Plus
                      className={`absolute inset-0 transition-all duration-300 ${
                        isOpen
                          ? "rotate-90 opacity-0 text-green-600"
                          : "rotate-0 opacity-100 text-gray-400"
                      }`}
                    />
                    <Minus
                      className={`absolute inset-0 transition-all duration-300 ${
                        isOpen
                          ? "rotate-0 opacity-100 text-green-600"

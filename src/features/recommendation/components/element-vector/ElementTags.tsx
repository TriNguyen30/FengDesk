...
import { ATTENTION_BG, ATTENTION_TEXT, elementColor, elementVi, gapStatus, type GapStatus } from "./constants";
      ...
      {rows.map((row) => {
        ...
        return (
          <span
            ...
            style={
              attention
                ? { backgroundColor: ATTENTION_BG, color: ATTENTION_TEXT, borderColor: "transparent" }
                : { backgroundColor: "#fff", color: "#6b7280", borderColor: "#e5e7eb" }
            }
          >
            <span className="h-2 w-2 shrink-0 rounded-full" style={{ backgroundColor: elementColor(row.element) }} />

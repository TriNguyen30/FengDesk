...
export default function EmptyState({ onCreateWorkspace }: EmptyStateProps) {
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-col items-center gap-3 rounded-2xl border border-dashed border-[#d5ddc9] bg-[#fafbf9] px-6 py-10 text-center">

...
export function inputClassName(hasError?: boolean) {
  return [
    ...
    hasError ? "border-danger focus:border-danger" : "border-gray-200 focus:border-green-600",
  ].join(" ");
}

export default function AuthField({ id, label, error, hint, children }: AuthFieldProps) {
  return (
    <div>

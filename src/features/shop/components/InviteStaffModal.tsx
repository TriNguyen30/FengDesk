      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:justify-end">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-primary px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-all hover:bg-primary-dark disabled:cursor-not-allowed disabled:opacity-60 cursor-pointer"
          >
            {assign.isPending ? (
              <>

    ...
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
          FengDesk luôn sẵn sàng lắng nghe và hỗ trợ bạn. Hãy để lại lời nhắn, chúng tôi sẽ phản hồi trong thời gian sớm nhất.
        </p>
      </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-gray-600">FPT University, Khu CNC<br />Quận 9, Hồ Chí Minh</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-gray-600">0123 456 789<br />0987 654 321</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-gray-600">support@fengdesk.vn<br />contact@fengdesk.vn</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-gray-600">Thứ 2 - Thứ 6: 08:00 - 20:00<br />Thứ 7 - CN: 09:00 - 18:00</p>
              </div>
            </div>
          </div>
        </div>

...
const featuredPost = {
  ...
  excerpt: "Việc chọn đúng cây phong thủy không chỉ giúp thanh lọc không khí mà còn mang lại may mắn, sức khỏe và tài lộc cho gia đình. Khám phá ngay cách chọn cây chuẩn xác nhất theo 5 bản mệnh: Kim, Mộc, Thủy, Hỏa, Thổ.",
  category: "Phong thủy",
  author: "Phong Thủy Guru",
  date: "12 Tháng 10, 2024",
  imageUrl: "https://images.squarespace-cdn.com/content/v1/663638597899f63cfa9deca6/1736727318707-KPNZ2QBTGEXVXAEC6WK8/7.16.24+Bristol+Botanics-27.jpg",
};
...
const posts = [
  {
    ...
    excerpt: "Tưới quá nhiều nước, đặt cây sai vị trí, không quan tâm đến ánh sáng... là những sai lầm khiến cây cảnh của bạn nhanh héo úa.",
    category: "Chăm sóc cây",
    author: "Admin",
    date: "10 Tháng 10, 2024",
    imageUrl: "https://s.yimg.com/ny/api/res/1.2/OjlgtatUjnfv6rMRAgVNSA--/YXBwaWQ9aGlnaGxhbmRlcjt3PTk2MDtoPTU0MDtjZj13ZWJw/https://media.zenfs.com/en/real_homes_245/4b07f622a522e2e612f3336385080532",
  },
  {
    id: 3,
    title: "Cây Kim Tiền: Ý nghĩa phong thủy và cách chăm sóc đúng chuẩn",
    excerpt: "Cây Kim Tiền được ví như thỏi nam châm hút tài lộc. Tuy nhiên để cây luôn xanh tốt và phát huy tối đa tác dụng phong thủy thì cần có bí quyết riêng.",
    category: "Mẹo vặt",
    author: "FengDesk Team",
    date: "05 Tháng 10, 2024",
    imageUrl: "https://www.thespruce.com/thmb/fQjL1wNf72Ez89dkS-VwpiQGiAM=/6127x0/filters:no_upscale():max_bytes(150000):strip_icc()/thespruce.com-best-houseplants-for-sun-4147670-1-3d69cd3cf2b943d9aa8363cde764e595.jpg",
  },
  {
    id: 4,
    title: "Top 7 loại cây để bàn làm việc giúp giảm căng thẳng hiệu quả",
    excerpt: "Không gian làm việc quá khô khan? Hãy bổ sung ngay những chậu cây nhỏ nhắn này để thanh lọc không khí và thư giãn tinh thần.",
    category: "Phong thủy",
    author: "Admin",
  ...
  },
  {
    ...
    excerpt: "Sen đá là loại cây dễ trồng nhưng cần hiểu rõ đặc tính của từng dòng. Bài viết hướng dẫn cách nhân giống sen đá thành công 100%.",
    category: "Chăm sóc cây",
    author: "Plant Lover",
  ...
  },
  {
    ...
    excerpt: "Mừng khai trương chi nhánh thứ 3, FengDesk tung hàng ngàn ưu đãi hấp dẫn cho khách hàng đến tham quan và mua sắm.",
    category: "Tin tức",
    author: "FengDesk Team",
    ...
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
          Cập nhật những thông tin mới nhất về phong thủy, cách chăm sóc cây cảnh và các mẹo trang trí không gian sống từ chuyên gia.
        </p>
      </div>
